...
/*   Updated: 2026/02/02 09:27:10 by thodavid         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int main()
{
    ...
    std::cout << "please enter some few integer and enter 'OK' (one line one int)\n";
    while (1)
    {
        std::string prompt;
        std::cout << "> ";
